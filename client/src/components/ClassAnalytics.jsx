  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="bg-gray-100 p-4 rounded-lg mb-4">
        ...
        <p>
          <strong>Class Name:</strong> {classData.className || "Not Assigned"}
        </p>
        <p>
          <strong>Year:</strong> {classData.year || "Not Assigned"}
        </p>
        <p>
          <strong>Teacher:</strong>{" "}
          {classData.teacher ? classData.teacher.name : "Not Assigned"}
        </p>
        <p>
          <strong>Student Fees:</strong> Rs {classData.studentFees || 0}
        </p>
        <p>
          <strong>Total Students:</strong> {students.length || 0}
        </p>
        <p>
          <strong>Male vs Female Students:</strong> {maleCount} Male,{" "}
          {femaleCount} Female
        </p>
      </div>
